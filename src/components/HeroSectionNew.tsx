      ...
      <div className="relative z-20 container mx-auto px-6 pt-24">
        ...
        <div className="text-center mb-16">
          <div className="relative">
            <h1 className="text-6xl md:text-8xl font-black mb-4 bg-gradient-to-r from-cyan-400 via-pink-500 to-yellow-400 bg-clip-text text-transparent animate-pulse">
              POWER UP
            </h1>
            <div className="absolute inset-0 text-6xl md:text-8xl font-black text-white opacity-10 transform translate-x-1 translate-y-1">
              POWER UP
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          ...
          <div className="group cursor-pointer transform hover:scale-105 transition-all duration-300">
            <div className="bg-gradient-to-br from-orange-500 to-red-600 rounded-2xl p-6 shadow-2xl relative overflow-hidden border-4 border-orange-300">
              ...
              <div className="mt-8">
                <h3 className="text-white font-bold text-3xl mb-4 flex items-center" style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.8)' }}>
                  💻 TECHNICAL
                </h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
          ...
          <div className="bg-black bg-opacity-40 backdrop-blur-lg rounded-2xl p-8 border border-purple-500 shadow-2xl">
            <h3 className="text-3xl font-bold text-white mb-6 flex items-center" style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.8)' }}>
              🎮 How to Play
            </h3>
            <div className="space-y-4">
              {[
                { step: 1, text: "Choose your domain", icon: "🎯" },
                { step: 2, text: "Scan QR to access challenges", icon: "📱" },
                { step: 3, text: "Complete tasks & level up", icon: "⚡" },
                { step: 4, text: "Join the GCSRM team!", icon: "🏆" }
              ].map(({ step, text, icon }) => (
          ...
          <div className="bg-gradient-to-br from-green-400 to-blue-500 rounded-2xl p-8 text-white shadow-2xl">
            <h3 className="text-3xl font-bold mb-6 flex items-center" style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.8)' }}>
              ⏰ Timeline
            </h3>
            <div className="space-y-4">
              {[
        ...
        <div className="text-center mb-16">
          ...
          <div className="mt-6 text-white text-xl">
            <p>Join <span className="text-yellow-400 font-bold text-2xl animate-pulse">500+</span> students already on their journey!</p>
          </div>
        </div>
      </div>
